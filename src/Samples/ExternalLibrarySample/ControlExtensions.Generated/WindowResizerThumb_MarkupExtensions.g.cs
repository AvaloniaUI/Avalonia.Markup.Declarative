...
public static T ResizeDirection<T>(this T control, Ursa.Controls.ResizeDirection value) where T : Ursa.Controls.WindowResizerThumb 
=> control._set(() => control.ResizeDirection = value!);

/*BindFromExpressionSetterGenerator*/
public static T ResizeDirection<T>(this T control, Func<Ursa.Controls.ResizeDirection> func, Action<Ursa.Controls.ResizeDirection>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : Ursa.Controls.WindowResizerThumb 
   => control._set(Ursa.Controls.WindowResizerThumb.ResizeDirectionProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T ResizeDirection<T>(this T control,Ursa.Controls.ResizeDirection value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : Ursa.Controls.WindowResizerThumb 
...
[Obsolete]
public static T ResizeDirection<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, Ursa.Controls.ResizeDirection> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : Ursa.Controls.WindowResizerThumb 
