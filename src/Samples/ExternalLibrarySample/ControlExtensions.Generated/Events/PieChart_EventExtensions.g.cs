...
{
    public static T OnMeasuring<T>(this T control, Action<SkiaSharpDrawingContext> action) where T : PieChart => 
        control._setEvent((ChartEventHandler<SkiaSharpDrawingContext>) ((_, args) => action(args)), h => control.Measuring += h);
    public static T OnUpdateStarted<T>(this T control, Action<SkiaSharpDrawingContext> action) where T : PieChart => 
        control._setEvent((ChartEventHandler<SkiaSharpDrawingContext>) ((_, args) => action(args)), h => control.UpdateStarted += h);
    public static T OnUpdateFinished<T>(this T control, Action<SkiaSharpDrawingContext> action) where T : PieChart => 
        control._setEvent((ChartEventHandler<SkiaSharpDrawingContext>) ((_, args) => action(args)), h => control.UpdateFinished += h);
    public static T OnDataPointerDown<T>(this T control, Action action) where T : PieChart => 
        control._setEvent((ChartPointsHandler) ((_, args) => action()), h => control.DataPointerDown += h);
    public static T OnChartPointPointerDown<T>(this T control, Action action) where T : PieChart => 
        control._setEvent((ChartPointHandler) ((_, args) => action()), h => control.ChartPointPointerDown += h);
    public static T OnVisualElementsPointerDown<T>(this T control, Action<SkiaSharpDrawingContext> action) where T : PieChart => 
