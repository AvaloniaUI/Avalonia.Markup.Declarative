...
public static class ComponentExtensions
{
    ...
    /// <summary>
    /// Used by autogenerated extensions from source generator for binding Common properties to ViewBase components
    /// </summary>
    /// <typeparam name="TControl"></typeparam>
    ...
    public static TControl _setCommonBindingEx<TControl, TValue>(this TControl control, Action<TValue?> setAction, IBinding binding)
        where TControl : AvaloniaObject
    {
        if (binding is ComponentBase.MvuBinding bindingEx)
        {
