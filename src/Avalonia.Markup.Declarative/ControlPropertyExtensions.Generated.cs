...
public static partial class MenuFlyoutPresenterExtensions
{
    ...
    public static MenuFlyoutPresenter CornerRadius<TValue>(this MenuFlyoutPresenter control, TValue value, FuncValueConverter<TValue, CornerRadius> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null) => control._setEx(MenuFlyoutPresenter.CornerRadiusProperty, ps, () => control.CornerRadius = (CornerRadius)converter.Convert(value, typeof(TValue), null, default), bindingMode, converter, bindingSource);
...
public static partial class NumericUpDownExtensions
{
    ...
    public static NumericUpDown CultureInfo<TValue>(this NumericUpDown control, TValue value, FuncValueConverter<TValue, CultureInfo> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null) => control._setEx(NumericUpDown.CultureInfoProperty, ps, () => control.CultureInfo = (CultureInfo)converter.Convert(value, typeof(TValue), null, default), bindingMode, converter, bindingSource);
    ...
    public static NumericUpDown Increment<TValue>(this NumericUpDown control, TValue value, FuncValueConverter<TValue, Double> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null) => control._setEx(NumericUpDown.IncrementProperty, ps, () => control.Increment = (Double)converter.Convert(value, typeof(TValue), null, default), bindingMode, converter, bindingSource);
    ...
    public static NumericUpDown Maximum<TValue>(this NumericUpDown control, TValue value, FuncValueConverter<TValue, Double> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null) => control._setEx(NumericUpDown.MaximumProperty, ps, () => control.Maximum = (Double)converter.Convert(value, typeof(TValue), null, default), bindingMode, converter, bindingSource);
    ...
    public static NumericUpDown Minimum<TValue>(this NumericUpDown control, TValue value, FuncValueConverter<TValue, Double> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null) => control._setEx(NumericUpDown.MinimumProperty, ps, () => control.Minimum = (Double)converter.Convert(value, typeof(TValue), null, default), bindingMode, converter, bindingSource);
    ...
    public static NumericUpDown Value<TValue>(this NumericUpDown control, TValue value, FuncValueConverter<TValue, Double> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null) => control._setEx(NumericUpDown.ValueProperty, ps, () => control.Value = (Double)converter.Convert(value, typeof(TValue), null, default), bindingMode, converter, bindingSource);
...
public static partial class PopupExtensions
{
    ...
    public static Popup ObeyScreenEdges<TValue>(this Popup control, TValue value, FuncValueConverter<TValue, Boolean> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null) => control._setEx(Popup.ObeyScreenEdgesProperty, ps, () => control.ObeyScreenEdges = (Boolean)converter.Convert(value, typeof(TValue), null, default), bindingMode, converter, bindingSource);
