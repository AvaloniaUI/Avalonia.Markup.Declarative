...
public static DatePicker Header<TValue>(this DatePicker control, TValue value, FuncValueConverter<TValue, Object> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(DatePicker.HeaderProperty, ps, () => control.Header = (Object)converter.Convert(value,typeof(TValue), null, default), bindingMode, converter, bindingSource);
...
public static DatePicker HeaderTemplate<TValue>(this DatePicker control, TValue value, FuncValueConverter<TValue, IDataTemplate> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(DatePicker.HeaderTemplateProperty, ps, () => control.HeaderTemplate = (IDataTemplate)converter.Convert(value,typeof(TValue), null, default), bindingMode, converter, bindingSource);
...
public static TimePicker Header<TValue>(this TimePicker control, TValue value, FuncValueConverter<TValue, Object> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(TimePicker.HeaderProperty, ps, () => control.Header = (Object)converter.Convert(value,typeof(TValue), null, default), bindingMode, converter, bindingSource);
...
public static TimePicker HeaderTemplate<TValue>(this TimePicker control, TValue value, FuncValueConverter<TValue, IDataTemplate> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(TimePicker.HeaderTemplateProperty, ps, () => control.HeaderTemplate = (IDataTemplate)converter.Convert(value,typeof(TValue), null, default), bindingMode, converter, bindingSource);
...
{
public static RichTextBlock IsTextSelectionEnabled(this RichTextBlock control, IBinding binding)
   => control._set(() => control[!RichTextBlock.IsTextSelectionEnabledProperty] = binding);
public static RichTextBlock IsTextSelectionEnabled(this RichTextBlock control, Boolean value = default, BindingMode? bindingMode = null, IValueConverter converter = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.IsTextSelectionEnabledProperty, ps, () => control.IsTextSelectionEnabled = value, bindingMode, converter, bindingSource);
public static RichTextBlock IsTextSelectionEnabled<TValue>(this RichTextBlock control, TValue value, FuncValueConverter<TValue, Boolean> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.IsTextSelectionEnabledProperty, ps, () => control.IsTextSelectionEnabled = (Boolean)converter.Convert(value,typeof(TValue), null, default), bindingMode, converter, bindingSource);
public static RichTextBlock SelectionStart(this RichTextBlock control, IBinding binding)
   => control._set(() => control[!RichTextBlock.SelectionStartProperty] = binding);
public static RichTextBlock SelectionStart(this RichTextBlock control, Int32 value = default, BindingMode? bindingMode = null, IValueConverter converter = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.SelectionStartProperty, ps, () => control.SelectionStart = value, bindingMode, converter, bindingSource);
public static RichTextBlock SelectionStart<TValue>(this RichTextBlock control, TValue value, FuncValueConverter<TValue, Int32> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.SelectionStartProperty, ps, () => control.SelectionStart = (Int32)converter.Convert(value,typeof(TValue), null, default), bindingMode, converter, bindingSource);
public static RichTextBlock SelectionEnd(this RichTextBlock control, IBinding binding)
   => control._set(() => control[!RichTextBlock.SelectionEndProperty] = binding);
public static RichTextBlock SelectionEnd(this RichTextBlock control, Int32 value = default, BindingMode? bindingMode = null, IValueConverter converter = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.SelectionEndProperty, ps, () => control.SelectionEnd = value, bindingMode, converter, bindingSource);
public static RichTextBlock SelectionEnd<TValue>(this RichTextBlock control, TValue value, FuncValueConverter<TValue, Int32> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.SelectionEndProperty, ps, () => control.SelectionEnd = (Int32)converter.Convert(value,typeof(TValue), null, default), bindingMode, converter, bindingSource);
public static RichTextBlock SelectionBrush(this RichTextBlock control, IBinding binding)
   => control._set(() => control[!RichTextBlock.SelectionBrushProperty] = binding);
public static RichTextBlock SelectionBrush(this RichTextBlock control, IBrush value = default, BindingMode? bindingMode = null, IValueConverter converter = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.SelectionBrushProperty, ps, () => control.SelectionBrush = value, bindingMode, converter, bindingSource);
public static RichTextBlock SelectionBrush<TValue>(this RichTextBlock control, TValue value, FuncValueConverter<TValue, IBrush> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.SelectionBrushProperty, ps, () => control.SelectionBrush = (IBrush)converter.Convert(value,typeof(TValue), null, default), bindingMode, converter, bindingSource);
public static RichTextBlock Inlines(this RichTextBlock control, IBinding binding)
   => control._set(() => control[!RichTextBlock.InlinesProperty] = binding);
public static RichTextBlock Inlines(this RichTextBlock control, InlineCollection value = default, BindingMode? bindingMode = null, IValueConverter converter = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.InlinesProperty, ps, () => control.Inlines = value, bindingMode, converter, bindingSource);
public static RichTextBlock Inlines<TValue>(this RichTextBlock control, TValue value, FuncValueConverter<TValue, InlineCollection> converter, BindingMode? bindingMode = null, object bindingSource = null, [CallerArgumentExpression("value")] string ps = null)=> control._setEx(RichTextBlock.InlinesProperty, ps, () => control.Inlines = (InlineCollection)converter.Convert(value,typeof(TValue), null, default), bindingMode, converter, bindingSource);
}
