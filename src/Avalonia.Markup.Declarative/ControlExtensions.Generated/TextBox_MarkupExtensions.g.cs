...
public static T OnCopyingToClipboard<T>(this T control, Action<Avalonia.Interactivity.RoutedEventArgs> action, Avalonia.Interactivity.RoutingStrategies routes = 0) where T : Avalonia.Controls.TextBox 
{
  if (routes == 0) routes = Avalonia.Controls.TextBox.CopyingToClipboardEvent.RoutingStrategies;
...
/*ActionToEventGenerator*/
public static T OnCuttingToClipboard<T>(this T control, Action<Avalonia.Interactivity.RoutedEventArgs> action, Avalonia.Interactivity.RoutingStrategies routes = 0) where T : Avalonia.Controls.TextBox 
{
  if (routes == 0) routes = Avalonia.Controls.TextBox.CuttingToClipboardEvent.RoutingStrategies;
...
/*ActionToEventGenerator*/
public static T OnPastingFromClipboard<T>(this T control, Action<Avalonia.Interactivity.RoutedEventArgs> action, Avalonia.Interactivity.RoutingStrategies routes = 0) where T : Avalonia.Controls.TextBox 
{
  if (routes == 0) routes = Avalonia.Controls.TextBox.PastingFromClipboardEvent.RoutingStrategies;
...
/*ActionToEventGenerator*/
public static T OnTextChanged<T>(this T control, Action<Avalonia.Controls.TextChangedEventArgs> action, Avalonia.Interactivity.RoutingStrategies routes = 0) where T : Avalonia.Controls.TextBox 
{
  if (routes == 0) routes = Avalonia.Controls.TextBox.TextChangedEvent.RoutingStrategies;
...
/*ActionToEventGenerator*/
public static T OnTextChanging<T>(this T control, Action<Avalonia.Controls.TextChangingEventArgs> action, Avalonia.Interactivity.RoutingStrategies routes = 0) where T : Avalonia.Controls.TextBox 
{
  if (routes == 0) routes = Avalonia.Controls.TextBox.TextChangingEvent.RoutingStrategies;
