...
public static Avalonia.Media.ExperimentalAcrylicMaterial TintColor<T>(this T control,Avalonia.Media.Color value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.TintColorProperty, ps, () => control.TintColor = value, bindingMode, converter, bindingSource);
...
public static T TintColor<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, Avalonia.Media.Color> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.TintColorProperty, ps, () => control.TintColor = converter.TryConvert(value), bindingMode, converter, bindingSource);
...
/*MagicalSetterGenerator*/
public static Avalonia.Media.ExperimentalAcrylicMaterial BackgroundSource<T>(this T control,Avalonia.Media.AcrylicBackgroundSource value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.BackgroundSourceProperty, ps, () => control.BackgroundSource = value, bindingMode, converter, bindingSource);
...
/*MagicalSetterWithConverterGenerator*/
public static T BackgroundSource<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, Avalonia.Media.AcrylicBackgroundSource> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.BackgroundSourceProperty, ps, () => control.BackgroundSource = converter.TryConvert(value), bindingMode, converter, bindingSource);
...
/*MagicalSetterGenerator*/
public static Avalonia.Media.ExperimentalAcrylicMaterial TintOpacity<T>(this T control,System.Double value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.TintOpacityProperty, ps, () => control.TintOpacity = value, bindingMode, converter, bindingSource);
...
/*MagicalSetterWithConverterGenerator*/
public static T TintOpacity<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Double> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.TintOpacityProperty, ps, () => control.TintOpacity = converter.TryConvert(value), bindingMode, converter, bindingSource);
...
/*MagicalSetterGenerator*/
public static Avalonia.Media.ExperimentalAcrylicMaterial MaterialOpacity<T>(this T control,System.Double value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.MaterialOpacityProperty, ps, () => control.MaterialOpacity = value, bindingMode, converter, bindingSource);
...
/*MagicalSetterWithConverterGenerator*/
public static T MaterialOpacity<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Double> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.MaterialOpacityProperty, ps, () => control.MaterialOpacity = converter.TryConvert(value), bindingMode, converter, bindingSource);
...
/*MagicalSetterGenerator*/
public static Avalonia.Media.ExperimentalAcrylicMaterial PlatformTransparencyCompensationLevel<T>(this T control,System.Double value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.PlatformTransparencyCompensationLevelProperty, ps, () => control.PlatformTransparencyCompensationLevel = value, bindingMode, converter, bindingSource);
...
/*MagicalSetterWithConverterGenerator*/
public static T PlatformTransparencyCompensationLevel<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Double> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.PlatformTransparencyCompensationLevelProperty, ps, () => control.PlatformTransparencyCompensationLevel = converter.TryConvert(value), bindingMode, converter, bindingSource);
...
/*MagicalSetterGenerator*/
public static Avalonia.Media.ExperimentalAcrylicMaterial FallbackColor<T>(this T control,Avalonia.Media.Color value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.FallbackColorProperty, ps, () => control.FallbackColor = value, bindingMode, converter, bindingSource);
...
/*MagicalSetterWithConverterGenerator*/
public static T FallbackColor<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, Avalonia.Media.Color> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.Media.ExperimentalAcrylicMaterial=> control._setEx(Avalonia.Media.ExperimentalAcrylicMaterial.FallbackColorProperty, ps, () => control.FallbackColor = converter.TryConvert(value), bindingMode, converter, bindingSource);
