...
public static T TemplatedControl_IsTemplateFocusTarget<T>(this T control, System.Boolean value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : Avalonia.Controls.Control
...
public static T TemplatedControl_IsTemplateFocusTarget<T>(this T control, Func<System.Boolean> func, Action<System.Boolean>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : Avalonia.Controls.Control 
...
public static T OnTemplateApplied<T>(this T control, Action<Avalonia.Controls.Primitives.TemplateAppliedEventArgs> action, Avalonia.Interactivity.RoutingStrategies routes = 0) where T : Avalonia.Controls.Primitives.TemplatedControl 
{
  if (routes == 0) routes = Avalonia.Controls.Primitives.TemplatedControl.TemplateAppliedEvent.RoutingStrategies;
