...
return control._setEvent((EventHandler<ResourcesChangedEventArgs>) Handler, h => control.ResourcesChanged += h);
}
...
return control._setEvent((EventHandler<UrlOpenedEventArgs>) Handler, h => control.UrlsOpened += h);
}
}
...
return control._setEvent((EventHandler) Handler, h => control.TextChanged += h);
}
...
return control._setEvent((EventHandler<PopulatingEventArgs>) Handler, h => control.Populating += h);
}
...
return control._setEvent((EventHandler<PopulatedEventArgs>) Handler, h => control.Populated += h);
}
...
return control._setEvent((EventHandler<CancelEventArgs>) Handler, h => control.DropDownOpening += h);
}
public static AutoCompleteBox OnDropDownOpened(this AutoCompleteBox control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.DropDownOpened += h);
}
public static AutoCompleteBox OnDropDownClosing(this AutoCompleteBox control, Action<CancelEventArgs> action) {
void Handler(object sender, CancelEventArgs args) => action(args);
return control._setEvent((EventHandler<CancelEventArgs>) Handler, h => control.DropDownClosing += h);
}
public static AutoCompleteBox OnDropDownClosed(this AutoCompleteBox control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.DropDownClosed += h);
}
...
return control._setEvent((EventHandler<SelectionChangedEventArgs>) Handler, h => control.SelectionChanged += h);
}
}
...
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.Click += h);
}
}
...
void Handler(object sender, SelectionChangedEventArgs args) => action(args);
return control._setEvent((EventHandler<SelectionChangedEventArgs>) Handler, h => control.SelectedDatesChanged += h);
}
...
return control._setEvent((EventHandler<CalendarDateChangedEventArgs>) Handler, h => control.DisplayDateChanged += h);
}
...
return control._setEvent((EventHandler<CalendarModeChangedEventArgs>) Handler, h => control.DisplayModeChanged += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.CalendarClosed += h);
}
public static CalendarDatePicker OnCalendarOpened(this CalendarDatePicker control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.CalendarOpened += h);
}
...
return control._setEvent((EventHandler<CalendarDatePickerDateValidationErrorEventArgs>) Handler, h => control.DateValidationError += h);
}
...
void Handler(object sender, SelectionChangedEventArgs args) => action(args);
return control._setEvent((EventHandler<SelectionChangedEventArgs>) Handler, h => control.SelectedDateChanged += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((CancelEventHandler) Handler, h => control.ContextMenuOpening += h);
}
public static ContextMenu OnContextMenuClosing(this ContextMenu control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((CancelEventHandler) Handler, h => control.ContextMenuClosing += h);
}
}
...
return control._setEvent((EventHandler<ContextRequestedEventArgs>) Handler, h => control.ContextRequested += h);
}
}
...
return control._setEvent((EventHandler<DatePickerSelectedValueChangedEventArgs>) Handler, h => control.SelectedDateChanged += h);
}
}
...
return control._setEvent((EventHandler<TimePickerSelectedValueChangedEventArgs>) Handler, h => control.SelectedTimeChanged += h);
}
}
...
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.MenuOpened += h);
}
public static MenuBase OnMenuClosed(this MenuBase control, Action<RoutedEventArgs> action) {
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.MenuClosed += h);
}
}
...
return control._setEvent((EventHandler<PointerEventArgs>) Handler, h => control.PointerEnterItem += h);
}
public static MenuItem OnPointerLeaveItem(this MenuItem control, Action<PointerEventArgs> action) {
void Handler(object sender, PointerEventArgs args) => action(args);
return control._setEvent((EventHandler<PointerEventArgs>) Handler, h => control.PointerLeaveItem += h);
}
public static MenuItem OnSubmenuOpened(this MenuItem control, Action<RoutedEventArgs> action) {
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.SubmenuOpened += h);
}
}
...
return control._setEvent((EventHandler<EventArgs>) Handler, h => control.NeedsUpdate += h);
}
public static NativeMenu OnOpening(this NativeMenu control, Action<EventArgs> action) {
void Handler(object sender, EventArgs args) => action(args);
return control._setEvent((EventHandler<EventArgs>) Handler, h => control.Opening += h);
}
public static NativeMenu OnClosed(this NativeMenu control, Action<EventArgs> action) {
void Handler(object sender, EventArgs args) => action(args);
return control._setEvent((EventHandler<EventArgs>) Handler, h => control.Closed += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Click += h);
}
public static NativeMenuItem OnClicked(this NativeMenuItem control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Clicked += h);
}
}
...
return control._setEvent((EventHandler<SpinEventArgs>) Handler, h => control.Spinned += h);
}
...
return control._setEvent((EventHandler<NumericUpDownValueChangedEventArgs>) Handler, h => control.ValueChanged += h);
}
}
...
return control._setEvent((EventHandler<ItemsRepeaterElementClearingEventArgs>) Handler, h => control.ElementClearing += h);
}
...
return control._setEvent((EventHandler<ItemsRepeaterElementIndexChangedEventArgs>) Handler, h => control.ElementIndexChanged += h);
}
...
return control._setEvent((EventHandler<ItemsRepeaterElementPreparedEventArgs>) Handler, h => control.ElementPrepared += h);
}
}
...
return control._setEvent((EventHandler<ScrollChangedEventArgs>) Handler, h => control.ScrollChanged += h);
}
}
...
void Handler(object sender, SpinEventArgs args) => action(args);
return control._setEvent((EventHandler<SpinEventArgs>) Handler, h => control.Spin += h);
}
}
...
void Handler(object sender, EventArgs args) => action(args);
return control._setEvent((EventHandler<EventArgs>) Handler, h => control.PaneClosed += h);
}
...
return control._setEvent((EventHandler<SplitViewPaneClosingEventArgs>) Handler, h => control.PaneClosing += h);
}
public static SplitView OnPaneOpened(this SplitView control, Action<EventArgs> action) {
void Handler(object sender, EventArgs args) => action(args);
return control._setEvent((EventHandler<EventArgs>) Handler, h => control.PaneOpened += h);
}
public static SplitView OnPaneOpening(this SplitView control, Action<EventArgs> action) {
void Handler(object sender, EventArgs args) => action(args);
return control._setEvent((EventHandler<EventArgs>) Handler, h => control.PaneOpening += h);
}
}
...
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.CopyingToClipboard += h);
}
public static TextBox OnCuttingToClipboard(this TextBox control, Action<RoutedEventArgs> action) {
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.CuttingToClipboard += h);
}
public static TextBox OnPastingFromClipboard(this TextBox control, Action<RoutedEventArgs> action) {
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.PastingFromClipboard += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Opened += h);
}
public static TopLevel OnClosed(this TopLevel control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Closed += h);
}
}
...
void Handler(object sender, CancelEventArgs args) => action(args);
return control._setEvent((EventHandler<CancelEventArgs>) Handler, h => control.Closing += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Activated += h);
}
public static WindowBase OnDeactivated(this WindowBase control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Deactivated += h);
}
...
return control._setEvent((EventHandler<PixelPointEventArgs>) Handler, h => control.PositionChanged += h);
}
}
...
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.NotificationClosed += h);
}
}
...
return control._setEvent((EventHandler<PointerPressedEventArgs>) Handler, h => control.CalendarLeftMouseButtonDown += h);
}
...
return control._setEvent((EventHandler<PointerReleasedEventArgs>) Handler, h => control.CalendarLeftMouseButtonUp += h);
}
}
...
void Handler(object sender, PointerPressedEventArgs args) => action(args);
return control._setEvent((EventHandler<PointerPressedEventArgs>) Handler, h => control.CalendarDayButtonMouseDown += h);
}
...
void Handler(object sender, PointerReleasedEventArgs args) => action(args);
return control._setEvent((EventHandler<PointerReleasedEventArgs>) Handler, h => control.CalendarDayButtonMouseUp += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.ScrollInvalidated += h);
}
public static DateTimePickerPanel OnSelectionChanged(this DateTimePickerPanel control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.SelectionChanged += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Confirmed += h);
}
public static PickerPresenterBase OnDismissed(this PickerPresenterBase control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Dismissed += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Opening += h);
}
}
...
return control._setEvent((EventHandler<ScrollEventArgs>) Handler, h => control.Scroll += h);
}
}
...
return control._setEvent((EventHandler<TemplateAppliedEventArgs>) Handler, h => control.TemplateApplied += h);
}
}
...
return control._setEvent((EventHandler<VectorEventArgs>) Handler, h => control.DragStarted += h);
}
public static Thumb OnDragDelta(this Thumb control, Action<VectorEventArgs> action) {
void Handler(object sender, VectorEventArgs args) => action(args);
return control._setEvent((EventHandler<VectorEventArgs>) Handler, h => control.DragDelta += h);
}
public static Thumb OnDragCompleted(this Thumb control, Action<VectorEventArgs> action) {
void Handler(object sender, VectorEventArgs args) => action(args);
return control._setEvent((EventHandler<VectorEventArgs>) Handler, h => control.DragCompleted += h);
}
}
...
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.Checked += h);
}
public static ToggleButton OnUnchecked(this ToggleButton control, Action<RoutedEventArgs> action) {
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.Unchecked += h);
}
public static ToggleButton OnIndeterminate(this ToggleButton control, Action<RoutedEventArgs> action) {
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.Indeterminate += h);
}
}
...
return control._setEvent((EventHandler<GotFocusEventArgs>) Handler, h => control.GotFocus += h);
}
public static InputElement OnLostFocus(this InputElement control, Action<RoutedEventArgs> action) {
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.LostFocus += h);
}
...
return control._setEvent((EventHandler<KeyEventArgs>) Handler, h => control.KeyDown += h);
}
public static InputElement OnKeyUp(this InputElement control, Action<KeyEventArgs> action) {
void Handler(object sender, KeyEventArgs args) => action(args);
return control._setEvent((EventHandler<KeyEventArgs>) Handler, h => control.KeyUp += h);
}
...
return control._setEvent((EventHandler<TextInputEventArgs>) Handler, h => control.TextInput += h);
}
...
return control._setEvent((EventHandler<TextInputMethodClientRequestedEventArgs>) Handler, h => control.TextInputMethodClientRequested += h);
}
...
return control._setEvent((EventHandler<TextInputOptionsQueryEventArgs>) Handler, h => control.TextInputOptionsQuery += h);
}
public static InputElement OnPointerEnter(this InputElement control, Action<PointerEventArgs> action) {
void Handler(object sender, PointerEventArgs args) => action(args);
return control._setEvent((EventHandler<PointerEventArgs>) Handler, h => control.PointerEnter += h);
}
public static InputElement OnPointerLeave(this InputElement control, Action<PointerEventArgs> action) {
void Handler(object sender, PointerEventArgs args) => action(args);
return control._setEvent((EventHandler<PointerEventArgs>) Handler, h => control.PointerLeave += h);
}
public static InputElement OnPointerMoved(this InputElement control, Action<PointerEventArgs> action) {
void Handler(object sender, PointerEventArgs args) => action(args);
return control._setEvent((EventHandler<PointerEventArgs>) Handler, h => control.PointerMoved += h);
}
public static InputElement OnPointerPressed(this InputElement control, Action<PointerPressedEventArgs> action) {
void Handler(object sender, PointerPressedEventArgs args) => action(args);
return control._setEvent((EventHandler<PointerPressedEventArgs>) Handler, h => control.PointerPressed += h);
}
public static InputElement OnPointerReleased(this InputElement control, Action<PointerReleasedEventArgs> action) {
void Handler(object sender, PointerReleasedEventArgs args) => action(args);
return control._setEvent((EventHandler<PointerReleasedEventArgs>) Handler, h => control.PointerReleased += h);
}
...
return control._setEvent((EventHandler<PointerCaptureLostEventArgs>) Handler, h => control.PointerCaptureLost += h);
}
...
return control._setEvent((EventHandler<PointerWheelEventArgs>) Handler, h => control.PointerWheelChanged += h);
}
public static InputElement OnTapped(this InputElement control, Action<RoutedEventArgs> action) {
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.Tapped += h);
}
public static InputElement OnDoubleTapped(this InputElement control, Action<RoutedEventArgs> action) {
void Handler(object sender, RoutedEventArgs args) => action(args);
return control._setEvent((EventHandler<RoutedEventArgs>) Handler, h => control.DoubleTapped += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.MeasureInvalidated += h);
}
public static AttachedLayout OnArrangeInvalidated(this AttachedLayout control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.ArrangeInvalidated += h);
}
}
...
return control._setEvent((EventHandler<EffectiveViewportChangedEventArgs>) Handler, h => control.EffectiveViewportChanged += h);
}
public static Layoutable OnLayoutUpdated(this Layoutable control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.LayoutUpdated += h);
}
}
...
return control._setEvent((EventHandler<VisualTreeAttachmentEventArgs>) Handler, h => control.AttachedToVisualTree += h);
}
public static Visual OnDetachedFromVisualTree(this Visual control, Action<VisualTreeAttachmentEventArgs> action) {
void Handler(object sender, VisualTreeAttachmentEventArgs args) => action(args);
return control._setEvent((EventHandler<VisualTreeAttachmentEventArgs>) Handler, h => control.DetachedFromVisualTree += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Invalidated += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Changed += h);
}
}
...
return control._setEvent((EventHandler<LogicalTreeAttachmentEventArgs>) Handler, h => control.AttachedToLogicalTree += h);
}
...
void Handler(object sender, LogicalTreeAttachmentEventArgs args) => action(args);
return control._setEvent((EventHandler<LogicalTreeAttachmentEventArgs>) Handler, h => control.DetachedFromLogicalTree += h);
}
public static StyledElement OnDataContextChanged(this StyledElement control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.DataContextChanged += h);
}
public static StyledElement OnInitialized(this StyledElement control, Action action) {
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.Initialized += h);
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((EventHandler) Handler, h => control.OwnerChanged += h);
}
}
...
void Handler(object sender, EventArgs args) => action();
return control._setEvent((NotifyCollectionChangedEventHandler) Handler, h => control.CollectionChanged += h);
}
...
return control._setEvent((EventHandler<AvaloniaPropertyChangedEventArgs>) Handler, h => control.PropertyChanged += h);
}
}
